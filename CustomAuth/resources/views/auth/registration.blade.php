            ...
            <div class="col-md-4 col-md-offset-4">
                ...
                <form action="{{ route('registering.user') }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="name" class="form-control @error('name') error @enderror" placeholder="Enter Full Name" value="">
                        @if ($errors->has('name'))
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password_confirmation" class="form-control @error('password_confirmation') is-invalid @enderror" id="password_confirmation" value="{{ old('password_confirmation') }}" placeholder="Enter Confirm Password">
